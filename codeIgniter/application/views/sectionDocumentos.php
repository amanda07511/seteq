                ...
                <tbody>
                  ...
                  <tr>
                    <tr id="tr-<?=$results->idDoc?>">
                      <td class="col-sm-2"><?=$results->titulo?></td>
                      <td><?=$results->carpeta?></td>
                    ...
                    <?php if($this->session->userdata('tipo') != null): ?>
                      <td class="col-sm-1">
                        <a type="button" class="a-modificar btn btn-warning" href="<?=$results->idDoc?>" style="color: #fff;"><i class="far fa-edit"></i>&nbsp;</a>
                      </td>
                      <td class="col-sm-1">
